...
* Dev info
- Used godot 4.2.1 originally, updating to Godot 4.6
- Replace path 'src/dummy_godot_project/test_project.x86_64' with godot binary
** Dev dependencies
- =clang= :: Is used to obtain "gdextension_interface.h" AST
- =clj-kondo= :: Static analysis and linting
- =openjdk-25= :: Is used to be able to compile the shared library
** Scripts
...
*** TODO Fix SDL noise on bin/test-godot test with Godot 4.6
